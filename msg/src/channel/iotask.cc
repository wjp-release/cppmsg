...
status read_task::try_scatter_input(int fd, int backoff, std::unique_lock<std::mutex>& lk){
...
status write_task::try_gather_output(int fd, int backoff, std::unique_lock<std::mutex>& lk){
